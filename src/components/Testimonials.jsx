            ...
            <div className='flex flex-wrap justify-center mt-8'>
                <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <p className='text-gray-600'>Amazing service! I am very satisfied with their work.</p>
                ...
                <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <p className='text-gray-800 font-semibold mt-4'>Jame Smith</p>
                    </div>
                </div>
                ...
                <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <p className='text-gray-800 font-semibold mt-4'>Sam Smith</p>
                    </div>
                </div>
            </div>
        </div>
